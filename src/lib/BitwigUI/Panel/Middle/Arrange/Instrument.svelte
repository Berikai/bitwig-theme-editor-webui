        ...
        <span class="instrument {isSelected ? "selected-inst" : "unselected-inst"}" style="display:flex;justify-content:flex-start;background-color:{isSelected ? theme["window"]["Selected Panel body"] : theme["window"]["Panel body"]};">
            ...
            <span style="display:flex;flex-direction:column;width:100%;">
                <span style="display:flex;justify-content:space-between;width:100%;">
                    <i style="margin-left:6px;color:{isSelected ? theme["window"]["Dark Text"] : theme["window"]["Light Text"]};">{name}</i>
                    <span style="display: flex;">
                        <span class="button {isRec ? "rec" : "button-background"}" style={isRec ? "background-color:red;background-image:none;" : ""}>
                            <svg class="circle {isRec ? "dark-text" : "light-text"}" width="9px" height="9px">
                                <circle cx="4.5" cy="4.5" r="4.5" fill={isRec ? theme["window"]["Dark Text"] : theme["window"]["Light Text"]} />
                            </svg>
                        </span>
                ...
                <span style="display:flex;justify-content:space-between;width:100%;">
                    {#if type === "a"}
                    <svg class={isSelected ? "dark-text" : "light-text"} width="15px" height="15px" viewBox="0 0 15 15" stroke={isSelected ? theme["window"]["Dark Text"] : theme["window"]["Light Text"]} style="margin-left:6px;margin-top:3px;fill-rule:evenodd;clip-rule:evenodd;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:1.5;">
                        <g>
                    ...
                    {/if}
                    {#if type === "i"}
                    <svg class={isSelected ? "dark-text" : "light-text"} width="15px" height="15px" viewBox="0 0 15 15" fill={isSelected ? theme["window"]["Dark Text"] : theme["window"]["Light Text"]} style="opacity: 0.7;margin-left:6px;margin-top:4px;fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;">
                        <g>
                    ...
                    {/if}
                    {#if type === "m"}
                    <svg class={isSelected ? "dark-text" : "light-text"} width="15px" height="15px" fill={isSelected ? theme["window"]["Dark Text"] : theme["window"]["Light Text"]} style="margin-left:6px;margin-top:3px;fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;">
                        <g>
                    ...
                    {/if}
                    {#if type === "f"}
                    <svg class={isSelected ? "dark-text" : "light-text"} width="15px" height="15px" viewBox="0 0 15 15" fill={isSelected ? theme["window"]["Dark Text"] : theme["window"]["Light Text"]} style="margin-left:6px;margin-top:3px;fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;">
                        <g>
                    ...
                    <span class="button button-background" style="margin-top:3px;margin-left:6px;">
                        <svg width="15px" height="15px" fill={theme["window"]["Light Text"]} style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:1.41421;"><rect x="3" y="3" width="9" height="2"/><rect x="3" y="6.5" width="9" height="1.989"/><rect x="3" y="10" width="9" height="2"/></svg>
                    </span>
                </span>
            </span>
